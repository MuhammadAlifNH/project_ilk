    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div class="flex-1 grid grid-cols-1 gap-5">
            ...
            <div>
                ...
                <x-text-input id="phone" name="phone" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" :value="old('phone', $user->phone)" required autofocus autocomplete="phone" />
